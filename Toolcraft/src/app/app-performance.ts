...
export const appPerformance: ToolcraftPerformanceConfig = defineToolcraftPerformance({
  ...
  rendererPipeline: {
    interactionInvalidation: [
      ...
      },
      {
        ...
        invalidates: ["cell-sample", "module-assign", "mural-draw"],
        mustNotInvalidate: ["artwork-decode"],
        targets: ["artwork.scale", "artwork.padding", "artwork.spacing"],
      },
      {
        interaction: "control-change",
        invalidates: ["module-assign", "mural-draw"],
  ...
  scenarios: [
    ...
    },
    {
      ...
      browser: true,
      browserTestName: "browser perf: artwork size drag stays live within budget",
      budget: { ...responsivenessBudget },
      controlLabel: "Size",
      expectedObservable:
        "Dragging Size re-runs the cached artwork downsample and redraws the grid live within budget.",
      fixture: "Uploaded artwork, then drag Size to 400%.",
      id: "artwork-size-drag",
      interaction: "control-drag",
      ...
      stressFixture: {
        ...
        reason: "400% is the largest artwork size multiplier the slider exposes.",
        value: 400,
      },
      values: { default: 100, max: 400, min: 25 },
      workload: true,
    },
    {
      automated: true,
      ...
      browser: true,
      browserTestName: "browser perf: artwork padding drag stays live within budget",
      budget: { ...responsivenessBudget },
      controlLabel: "Padding",
      expectedObservable:
        "Dragging Padding re-runs the cached artwork downsample and redraws the grid live within budget.",
      fixture: "Uploaded artwork, then drag Padding to 12 tiles.",
      id: "artwork-padding-drag",
      interaction: "control-drag",
      ...
      stressFixture: {
        ...
        reason: "12 tiles is the largest padding the slider exposes.",
        value: 12,
      },
      values: { default: 0, max: 12, min: 0 },
      workload: true,
    },
    {
      automated: true,
      ...
      browser: true,
      browserTestName: "browser perf: repeat spacing drag stays live within budget",
      budget: { ...responsivenessBudget },
      controlLabel: "Spacing",
      expectedObservable:
        "Dragging Spacing in repeat mode re-runs the cached artwork downsample and redraws the grid live within budget.",
      fixture: "Uploaded artwork in Repeat placement, then drag Spacing to 12 tiles.",
      id: "repeat-spacing-drag",
      interaction: "control-drag",
      ...
      stressFixture: {
        ...
        reason: "12 tiles is the largest repeat spacing the slider exposes.",
        value: 12,
      },
      values: { default: 0, max: 12, min: 0 },
      workload: true,
    ...
    makeControlChangeScenario({
      ...
      browserTestName: "browser perf: paint tool change stays within budget",
      controlLabel: "Tool",
      expectedObservable:
        "Choosing a tool switches canvas pointer handling within budget without redrawing the grid.",
      fixture: "Click each Tool segment.",
      id: "paint-tool-change",
      target: "paint.tool",
    }),
    makeControlChangeScenario({
      automatedTestName: "paint color fills painted tile overrides",
      browserTestName: "browser perf: paint color change stays within budget",
      controlLabel: "Color",
      expectedObservable:
        "Committing a paint color updates runtime state within budget; it applies on the next paint or fill.",
      fixture: "Type a new paint hex value and commit.",
      id: "paint-color-change",
      target: "paint.color",
    }),
    makeControlChangeScenario({
      automatedTestName: "fill selected and clear painted update the override map",
      browserTestName: "browser perf: paint actions stay within budget",
      controlLabel: "Painted tiles",
      expectedObservable:
        "Painting a tile and clicking Clear painted reassigns overrides and redraws within budget.",
      fixture: "Paint one tile, then click Clear painted.",
      id: "paint-actions-run",
