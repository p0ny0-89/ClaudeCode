...
addPropertyControls(DepthMotionStack, {
    ...
    contentAdvanced: {
        ...
        controls: {
            ...
            responsiveSource: { type: ControlType.Boolean, title: "Responsive Source", defaultValue: false, enabledTitle: "On", disabledTitle: "Off", description: "Switches by viewport width in live preview." },
        },
        hidden: (props: any) => !props.parallax,
    },
    contentDesktop: {
